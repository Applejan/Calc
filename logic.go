...
//混凝土轴心抗压强度标准值
var gfcks []float64 = []float64{16.7, 20.1, 23.4, 26.8}

//混凝土轴心抗压强度设计值
var gfc []float64 = []float64{11.9, 14.3, 16.7, 19.1}

//混凝土轴心抗拉强度设计值
var gft []float64 = []float64{1.27, 1.43, 1.57, 1.71}

//混凝土弹性模量
var gec []float64 = []float64{2.8e+4, 3.0e+4, 3.15e+4, 3.25e+4}
